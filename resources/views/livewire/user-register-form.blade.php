        ...
        <div class="mt-5 sm:mx-auto sm:max-w-sm">
            ...
            <form action="#" method="POST" class="space-y-6" wire:submit.prevent="createNewUser">
                ...
                <div class="col-span-full">
                    <label for="cover-photo" class="block text-sm/6 font-medium text-gray-900">Profile photo</label>
                ...
                <div wire:loading wire:target="avatar" class="flex items-center justify-center w-20 h-20">
                    <div class="text-xs font-medium leading-none text-center text-gray-800  rounded-full animate-pulse">
                        loading...</div>
                </div>
                ...
                @if ($avatar)
                    ...
                    <img src="{{ $avatar->temporaryUrl() }}" class="rounded w-20 h-20 object-contain">
                @endif
                ...
                <div>
                    <button
                        ...
                        <svg wire:loading wire:target="createNewUser" aria-hidden="true"
                            class="w-5 h-5 text-gray-200 animate-spin fill-blue-600 me-2 self-center"
